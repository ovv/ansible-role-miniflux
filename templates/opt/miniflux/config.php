...
define('BASE_URL', '{{ miniflux_hostname |default() }}');
...
define('ENABLE_CRONJOB_HTTP_ACCESS', false);
...
// 'summaries' - Summaries
// 'full' - Full contents
define('READING_DISPLAY_MODE', 'titles');
...
define('READING_NOTHING_READ_REDIRECT', 'nowhere');
